Summary:	Afrikaans-Dutch language pair for Apertium
Summary(pl.UTF-8):	Para języków afrykanerski-holenderski dla Apertium
%define	lpair	af-nl
...
# Source0-md5:	c6e048623ab18cf58d6a2d7c2daafc63
...
between Afrikaans and Dutch, morphological analysis or part-of-speech
tagging of both languages.

%description -l pl.UTF-8
Ten pakiet zawiera parę języków dla Apertium służącą do tłumaczenia
między afrykanerskim a holenderskim, a także analizy morfologicznej
...
%{_datadir}/apertium/modes/af-nl.mode
%{_datadir}/apertium/modes/nl-af.mode
